...
if __name__ == '__main__':
    ...
    x_train, y_train, x_test, y_test = load_data(ROOT_PATH="./model_data")  # 加载数据
    ...
    json_file = './json_models/unpruned_tree_depth_' + str(max_depth) + '.json'
    ...
    json_file = './json_models/first_soft_pruned_tree.json'
    with open(json_file, 'w') as f:
